...
# 3. Global Live CSS Background Framework
# This creates a shifting, animated gradient matrix that mimics a live tactical gaming background loop
st.markdown("""
    <style>
    @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&family=Orbitron:wght@700;900&display=swap');
    
    /* Live Shifting Color Matrix Background */
    .stApp { 
        background: linear-gradient(125deg, #090d16, #1e050a, #0f172a, #2e0811);
...
if not st.session_state["logged_in"]:
    st.markdown("<h1 style='text-align: center; color: #ffffff; font-weight: 900; text-shadow: 0px 0px 18px #e11d48; letter-spacing: 4px;'>♱ ANARCHY ♱</h1>", unsafe_allow_html=True)
